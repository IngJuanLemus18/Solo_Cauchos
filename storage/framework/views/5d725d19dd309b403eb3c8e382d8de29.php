								...
								<div class="row">
									<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
										<div class="form-group label-floating">
											...
											<input type="text" class="form-control" name="name" placeholder=" Nombre del cliente " autocomplete="off" value="<?php echo e(old('name')); ?>">  
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\drogueria4\resources\views/suppliers\create.blade.php ENDPATH**/ ?>